--
-- Augemnted function making lib loading compatible with protoplug
--
...
print("phtread.lua: package.path:  "..package.path)
print("phtread.lua: package.cpath: "..package.cpath)
local C = ffi_load(lib)
